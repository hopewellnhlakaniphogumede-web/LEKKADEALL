...
test('non-mutation browser modules contain no application DML, RPC, broad select or blocked source', async () => {
  const mutationModules = new Set([
    'customer-bid-acceptance.js', 'customer-bid-viewing.js', 'provider-application.js', 'provider-bidding.js', 'provider-discovery.js', 'request-draft.js', 'request-cancellation.js',

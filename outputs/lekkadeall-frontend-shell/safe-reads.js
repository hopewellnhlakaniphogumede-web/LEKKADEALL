export const SAFE_PROJECTIONS = Object.freeze({
  ...
  providerStatus: 'user_id,business_name,bio,service_radius_km,verification_status,review_status,created_at,updated_at',
  customerRequests: 'id,category_id,title,description,suburb,city,requested_start,budget_minor,status,closes_at,created_at,updated_at',

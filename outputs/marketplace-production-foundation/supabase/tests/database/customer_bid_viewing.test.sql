...
from (
  values
    ...
    ('00000000-0000-4000-8000-0000000b0202', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Live request without bids', 'Canonical public request with no visible provider bids.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'open', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null),
    ('00000000-0000-4000-8000-0000000b0203', '00000000-0000-4000-8000-0000000a0003', '00000000-0000-4000-8000-0000000c0100', 'Foreign customer bid request', 'Canonical public request owned by another customer.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'open', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null),
    ('00000000-0000-4000-8000-0000000b0204', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Draft customer bid request', 'Draft request is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'draft', null, null, null, null),
    ('00000000-0000-4000-8000-0000000b0205', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Cancelled customer bid request', 'Cancelled request is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'cancelled', null, (select decision_at - '2 hours'::pg_catalog.interval from ticket10e_clock), null, (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock)),
    ('00000000-0000-4000-8000-0000000b0206', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Awarded customer bid request', 'Awarded request is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'awarded', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '2 hours'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null),
    ('00000000-0000-4000-8000-0000000b0207', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Unpublished customer bid request', 'Unpublished request is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'open', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), null, null, null),
    ('00000000-0000-4000-8000-0000000b0208', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Past close customer bid request', 'Past-close request is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'open', (select decision_at - '1 minute'::pg_catalog.interval from ticket10e_clock), (select decision_at - '2 hours'::pg_catalog.interval from ticket10e_clock), null, null),
    ('00000000-0000-4000-8000-0000000b0209', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Inconsistent customer bid request', 'Inconsistent request timing is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '2 days'::pg_catalog.interval from ticket10e_clock), 90000, 'open', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '2 hours'::pg_catalog.interval from ticket10e_clock), null, null),
    ('00000000-0000-4000-8000-0000000b0210', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Expired customer bid request', 'Expired request is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '2 days'::pg_catalog.interval from ticket10e_clock), 90000, 'expired', (select decision_at - '1 day'::pg_catalog.interval from ticket10e_clock), (select decision_at - '3 days'::pg_catalog.interval from ticket10e_clock), null, null),
    ('00000000-0000-4000-8000-0000000b0211', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0101', 'Inactive category bid request', 'Inactive category request is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'open', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null),
    ('00000000-0000-4000-8000-0000000b0212', '00000000-0000-4000-8000-0000000a0002', '00000000-0000-4000-8000-0000000c0100', 'Future publication bid request', 'Future publication state is unavailable for bid viewing.', 'Die Bult', 'Potchefstroom', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 90000, 'open', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at + '1 hour'::pg_catalog.interval from ticket10e_clock), null, null)
) as request(
  id, customer_id, category_id, title, description, suburb, city,
  requested_start, budget_minor, status, closes_at, published_at,
  awarded_at, cancelled_at
...
from (
  values
    ('00000000-0000-4000-8000-0000000d0323'::pg_catalog.uuid, '00000000-0000-4000-8000-0000000b0201'::pg_catalog.uuid, '00000000-0000-4000-8000-0000000e0023'::pg_catalog.uuid, 51023::pg_catalog.int4, 'ZAR'::pg_catalog.bpchar, (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null::pg_catalog.text, '{}'::pg_catalog.text[], 'withdrawn'::public.bid_status, (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null::pg_catalog.timestamptz, null::pg_catalog.timestamptz, (select decision_at - '30 minutes'::pg_catalog.interval from ticket10e_clock)),
    ('00000000-0000-4000-8000-0000000d0324', '00000000-0000-4000-8000-0000000b0201', '00000000-0000-4000-8000-0000000e0024', 51024, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, '{}', 'declined', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, (select decision_at - '30 minutes'::pg_catalog.interval from ticket10e_clock), null),
    ('00000000-0000-4000-8000-0000000d0325', '00000000-0000-4000-8000-0000000b0201', '00000000-0000-4000-8000-0000000e0025', 51025, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, '{}', 'accepted', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '30 minutes'::pg_catalog.interval from ticket10e_clock), null, null),
    ('00000000-0000-4000-8000-0000000d0326', '00000000-0000-4000-8000-0000000b0201', '00000000-0000-4000-8000-0000000e0026', 51026, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, '{}', 'expired', (select decision_at - '1 minute'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null, null),
    ('00000000-0000-4000-8000-0000000d0327', '00000000-0000-4000-8000-0000000b0201', '00000000-0000-4000-8000-0000000e0027', 51027, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, '{}', 'submitted', (select decision_at - '1 minute'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null, null),
    ('00000000-0000-4000-8000-0000000d0328', '00000000-0000-4000-8000-0000000b0201', '00000000-0000-4000-8000-0000000e0028', 51028, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, '{}', 'submitted', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null, null),
    ('00000000-0000-4000-8000-0000000d0329', '00000000-0000-4000-8000-0000000b0201', '00000000-0000-4000-8000-0000000e0029', 51029, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, '{}', 'submitted', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null, null),
    ('00000000-0000-4000-8000-0000000d0330', '00000000-0000-4000-8000-0000000b0201', '00000000-0000-4000-8000-0000000e0030', 51030, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), 'legacy hidden message', '{}', 'submitted', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null, null),
    ('00000000-0000-4000-8000-0000000d0331', '00000000-0000-4000-8000-0000000b0201', '00000000-0000-4000-8000-0000000e0031', 51031, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, array['legacy hidden perk'], 'submitted', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null, null),
    ('00000000-0000-4000-8000-0000000d0332', '00000000-0000-4000-8000-0000000b0203', '00000000-0000-4000-8000-0000000e0001', 52000, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, '{}', 'submitted', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null, null),
    ('00000000-0000-4000-8000-0000000d0333', '00000000-0000-4000-8000-0000000b0211', '00000000-0000-4000-8000-0000000e0001', 53000, 'ZAR', (select decision_at + '5 days'::pg_catalog.interval from ticket10e_clock), null, '{}', 'submitted', (select decision_at + '3 days'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), (select decision_at - '1 hour'::pg_catalog.interval from ticket10e_clock), null, null, null)
) as hidden(
  id, request_id, provider_id, amount_minor, currency, proposed_start,
  message, perks, status, expires_at, created_at, updated_at,
  accepted_at, declined_at, withdrawn_at
...
select is((select pg_catalog.array_agg(proc.proname::pg_catalog.text order by proc.proname) from pg_catalog.pg_proc as proc join pg_catalog.pg_namespace as namespace on namespace.oid = proc.pronamespace where namespace.nspname = 'public' and proc.proname like 'customer%bid%' and proc.proname <> 'customer_accept_bid'), array['customer_accept_current_bid','customer_list_current_bids','customer_reconcile_bid_acceptance']::pg_catalog.text[], 'only the reviewed bid viewing and Ticket 10F acceptance boundaries exist');
